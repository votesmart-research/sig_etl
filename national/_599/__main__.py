...
from national._599.extract import main as extract
...
def main():
    ...
    if not any((args.extract, args.transform, args.match)):
        ...
        extracted_by_candidatetype = extract(FILENAME + "Ratings", args.export_path)
        
        for candidatetype, records_extracted in extracted_by_candidatetype.items():
            save_records(
                records_extracted,
